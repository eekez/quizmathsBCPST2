...
from utils import commencer, afficher_questions, suivant, precedent, afficher_synthese
...
st.set_page_config(page_title="Quiz sur les suites", page_icon="🧠", layout="centered")
injecter_css()
