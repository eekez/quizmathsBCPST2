...
from utils17 import commencer, afficher_questions, suivant, precedent, afficher_synthese
...
st.set_page_config(page_title="Quiz sur les fonctions à deux variables", page_icon="🧠", layout="centered")
injecter_css()
