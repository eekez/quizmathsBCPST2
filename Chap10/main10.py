...
from utils10 import commencer, afficher_questions, suivant, precedent, afficher_synthese
...
st.set_page_config(page_title="Quiz sur les systèmes linéaires et matrices", page_icon="🧠", layout="centered")
injecter_css()
