...
from utils6 import commencer, afficher_questions, suivant, precedent, afficher_synthese
...
st.set_page_config(page_title="Quiz sur les nombres complexes", page_icon="🧠", layout="centered")
injecter_css()
